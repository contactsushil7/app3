...
<body>
    ...
    <form id="application"action="<?php echo  site_url('branch_manager_controller/') ?>" method="post">  
                ...
                <span class="add-on" style="background-color:#fff;margin-left:20px;"><i class="icosg-search"></i></span>
                 <input type="text" style="width: 209px;"  placeholder="Name,Email,Phone Number" id="staffsearch">     
                </div>  
                </div>
                </div>
                <div class="block-fluid">
                                ...
                                <?php foreach ($StaffList as $row){?>
                                      <tr class="<?php echo 's'.$row['staff_id'];?>">
                                        ...
                                        <td><a href="#bModal" data-toggle="modal" id="<?php echo $row['staff_id'];?>"  onClick="viewStaffDetails(this.id)"><?php echo$row["Name"];?></a></td>
                                        ...
                                        <td class="TAC">
                                              <a class="action1 tip" title="View Detail" id="<?php echo $row['staff_id']?>"  onClick="viewStaffDetails(this.id)" href="#bModal" data-toggle="modal"><span class="icon-ok"></span></a> 
                                                 <a class="action2" id="<?php echo $row['staff_id'];?>"  href="<?php echo site_url('branch_manager_controller/editstaff'."/".$row['staff_id']);?>"><span class="icon-pencil"></span></a> 
