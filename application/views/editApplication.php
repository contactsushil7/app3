    ...
    <div class="content" >
      <div class="row-fluid" style="overflow:x;">
       <?php foreach ($details as $row) {
               # code...
           ?>
        <form action="<?php echo  site_url('branch_manager_controller/updateApplication/'.$row['application_id']) ?>" method="post" enctype="multipart/form-data">
            ...
            <div>                
                ...
                <div class="widget">
                    <div class="head">
                        ...
                        <h2 align="centre"><b>Edit Application Form </b></h2>
                    </div>                        
