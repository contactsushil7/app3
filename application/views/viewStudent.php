...
<body>
    ...
    <div class="content">
               <div class="widget">
                ...
                <input type="text" style="width: 209px;"  placeholder="Name,Email,Phone Number" id="Student_search" >    
                </div>  
                </div>
                </div>
                                ...
                                foreach ($studentList as $row){
                                 ?>
                                    <tr class="<?php echo 's'.$row['student_id'];?>">
                                       ...
                                       <td><a href="#bModal" data-toggle="modal" id="<?php echo $row['student_id'];?>"  onClick="viewStudentDetails(this.id)"><?php echo $row["fname"]." ". $row["lname"];?></a></td>
                                        ...
                                        <td class="TAC">
                                            <a class="action1 tip" title="View Detail" id="<?php echo $row['student_id']?>"  onClick="viewStudentDetails(this.id)" href="#bModal" data-toggle="modal"><span class="icon-ok"></span></a> 
                                            <a class="action2" id="<?php echo $row['student_id'];?>"  href="<?php echo site_url('branch_manager_controller/editStudent'."/".$row['student_id']);?>"><span class="icon-pencil"></span></a> 
                                            <a class="action3 " id="<?php echo $row['student_id'];?>" onClick="deletesStudent(this.id)" href="#"><span class="icon-trash"></span></a>
                                        </td>
                                    </tr>
                                <?php }}?>               
                                </tbody>
