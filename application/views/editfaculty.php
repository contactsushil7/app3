...
<body>
       ...
       <?php foreach ($facultydetail as $row) {
               # code...
           ?>
    <div class="content" >
                <div class="row-fluid" style="overflow:x;">
         <form action="<?php echo  site_url('branch_manager_controller/updatefaculty/'.$row['teacher_id']) ?>" method="post" enctype="multipart/form-data">
