    ...
    <div class="content">
               <div class="widget">
                ...
                <div class="block-fluid">
                 ...
                 <div class="span3">
                <div >
                    <select input class="form-control input-md" name="Seeking_grade" id="exgrades" autocomplete="off">
                ...
                <input type="text" style="width: 209px;"  placeholder="Name,Email,Phone Number" id="exStudent_search" >    
                </div>  
                </div>
                </div>
                        ...
                        <div class="block-fluid">
                            <table class="table table-hover" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <?php if(!empty($exstudentList)){
                                foreach ($exstudentList as $row){
                                 ?>
                                    <tr class="<?php echo 's'.$row['student_id'];?>">
                                        <td><input type="checkbox" name="order[]" value="<?php echo $row['student_id'];?>"/></td>
                                       <td><a href="#bModal" data-toggle="modal" id="<?php echo $row['student_id'];?>"  onClick="viewexstudentdetails(this.id)"><?php echo $row["fname"]." ". $row["lname"];?></a></td>
                                        ...
                                        <td class="TAC">
                                            <a class="action1 tip" title="View Detail" id="<?php echo $row['student_id']?>"  onClick="viewexstudentdetails(this.id)" href="#bModal" data-toggle="modal"><span class="icon-ok"></span></a> 
                                            <a class="action2" id="<?php echo $row['student_id'];?>"  href="<?php echo site_url('branch_manager_controller/editexstudent'."/".$row['student_id']);?>"><span class="icon-pencil"></span></a> 
                                            <a class="action3 " id="<?php echo $row['student_id'];?>" onClick="deletesexstudent(this.id)" href="#"><span class="icon-trash"></span></a>
                                        </td>
                                    </tr>
                                <?php }}?>               
                                </tbody>
