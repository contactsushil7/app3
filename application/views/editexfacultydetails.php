...
<body>
       ...
       <?php foreach ($exfacultydetail as $row) {
               # code...
           ?>
    <div class="content" >
                <div class="row-fluid" style="overflow:x;">
         <form action="<?php echo  site_url('branch_manager_controller/updateexfaculty/'.$row['teacher_id']) ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="block-fluid">
                        ...
                        <div class="row-form">                    
                         ...
                         <div class="span2">Specilization</div>
                            <div class="span3"><input type="text" name="specilization"placeholder="Specilization in" value="<?php echo $row['specilization'];?>"></div>           
                        ...
                        <div class="span2">Phone</div>
                             ...
                             <div class="input-prepend">
                                    <span class="add-on"><i class="icosg-phone"></i></span>
                                    <input type="text" style="width: 209px;"  name="mobile"placeholder="Enter phone number" value="<?php echo $row['mobile'];?>">                               
                                </div>                  
                              </div>
                        </div>
                       ...
                       <div class="row-form">
                        ...
                        <div class="row-form">
                            ...
                            <div class="span3"><textarea  name="temp" placeholder="Placeholder example" ><?php echo $row['temporary'];?></textarea></div>
                        <div class="span2">Permanent address</div>
                            <div class="span3"><textarea  name="permanent"placeholder="Placeholder example" > <?php echo $row['permanent'];?></textarea></div>
