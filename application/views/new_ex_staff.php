...
<body>
   ...
   <form action="<?php echo site_url('admin/addnewexstaff');?>" method="post" enctype="multipart/form-data" name='staffregistration' onSubmit="return formValidation();">
    <div class="content">
                <div class="row-fluid">
